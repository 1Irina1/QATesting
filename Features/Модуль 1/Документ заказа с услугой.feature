...
Функционал: проверка заказа клиента на изменение количества по позиции услуги

Как Менеджер отедал продаж я хочу
проверить заполнение поля Количество позиции Услуги в заказе клиента 
чтобы убедиться в правильности работы функционала

Контекст: 
Дано Я открыл новый сеанс TestClient или подключил уже существующий

Сценарий: проверка заказа клиента на изменение количества по позиции услуги
...
* Проверка документа на заполнение поля количество
